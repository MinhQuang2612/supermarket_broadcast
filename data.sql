...
COPY public.activity_logs (id, user_id, action, details, "timestamp") FROM stdin;
...
COPY public.audio_files (id, filename, display_name, file_size, duration, sample_rate, file_type, status, uploaded_by, uploaded_at, audio_group_id) FROM stdin;
...
COPY public.audio_groups (id, name, frequency) FROM stdin;
1	greetings	1
2	promotions	1
3	tips	1
4	announcements	1
...
COPY public.broadcast_assignments (id, supermarket_id, broadcast_program_id, playlist_id, assigned_by, assigned_at) FROM stdin;
\.
...
COPY public.broadcast_programs (id, name, date, settings, created_by, created_at) FROM stdin;
\.
...
COPY public.communes (id, name, province_id) FROM stdin;
1	Cầu Giấy	1
2	Ba Đình	1
3	Hồng Bàng	2
4	Ngô Quyền	2
...
COPY public.playlists (id, broadcast_program_id, items, created_at) FROM stdin;
\.
...
COPY public.supermarket_types (id, name, display_name) FROM stdin;
...
COPY public.supermarkets (id, name, address, commune_id, province_id, region_id, status, current_program, created_at, supermarket_type_id) FROM stdin;
1	BIG C	904 Nguyễn Kiệm	1	1	1	active	\N	2025-05-12 15:10:36.247938	1
2	Siêu thị Mẫu Hà Nội	Số 123 Đường Lý Thường Kiệt	1	1	1	active	\N	2025-05-12 15:24:07.80725	1
3	Siêu thị Mẫu TP.HCM	Số 456 Đường Lê Lợi	13	7	3	active	\N	2025-05-12 15:24:07.817617	3
4	Siêu thị Mẫu Đà Nẵng	Số 789 Đường Nguyễn Văn Linh	7	4	2	active	\N	2025-05-12 15:24:07.821158	1
5	Siêu thị Mẫu Hải Phòng	Số 101 Đường Lạch Tray	3	2	1	active	\N	2025-05-12 15:24:07.823583	2
6	Siêu thị Mẫu Biên Hòa	Số 21 Điện Biên Phủ	18	9	3	active	\N	2025-05-12 15:24:07.825579	2
7	Siêu thị Mẫu Cần Thơ	Số 30 Đường 3/2	16	8	3	active	\N	2025-05-12 15:24:07.827938	1
8	Siêu thị Mẫu Quảng Nam	Số 5 Đường Trần Phú	10	5	2	active	\N	2025-05-12 15:24:07.831034	2
9	Siêu thị Mẫu Huế	Số 45 Đường Hùng Vương	12	6	2	active	\N	2025-05-12 15:24:07.833408	2
10	Siêu thị Mẫu Bắc Giang	Số 67 Đường Lý Thái Tổ	5	3	1	active	\N	2025-05-12 15:24:07.835587	1
11	Siêu thị Mẫu Đồng Nai	Số 88 Đường Trương Công Định	17	9	3	active	\N	2025-05-12 15:24:07.837916	3
\.
...
COPY public.users (id, username, password, full_name, role, status, created_at) FROM stdin;
